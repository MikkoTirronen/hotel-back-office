...
public class Room
{
    public int RoomId { get; private set; } // auto-generated by DB
    ...
    public Room(string roomNumber, RoomType type, int baseCapacity, int maxExtraBeds, decimal pricePerNight)
    {
